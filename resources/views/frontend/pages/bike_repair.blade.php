...
@section('content')
<section class="page-title-section top-position1 bg-img cover-background" data-overlay-dark="7" data-background="/front_assets/img/bg/bg-06.jpg" style="background-image: url(&quot;img/bg/bg-06.jpg&quot;);">
    <div class="container">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 order-2 order-lg-1">
                <div class="service-details-sidebar pe-lg-1-6 pe-xl-1-9">
                    <aside class="widget widget-nav-menu wow fadeIn" data-wow-delay="200ms" style="visibility: visible; animation-delay: 200ms; animation-name: fadeIn;">
                        <h4 class="widget-title">Bike Repair Services</h4>
                    </aside>
            ...
            <div class="col-lg-8 order-1 order-lg-2 mb-2-2 mb-lg-0">
                <img class="mb-2-2 rounded wow fadeIn" data-wow-delay="200ms" src="/front_assets/img/content/service-detail-01.jpg" style="border: 2px solid #cc1212;" alt="..." style="visibility: visible; animation-delay: 200ms; animation-name: fadeIn;">
                ...
                <div class="row mb-2-2 mt-n1-9">
                    <div class="col-md-6 mt-1-9 wow fadeIn" data-wow-delay="400ms" style="visibility: hidden; animation-delay: 400ms; animation-name: none;">
                        <img src="/front_assets/img/content/service-detail-02.png"  alt="...">
                    </div>
                    <div class="col-md-6 mt-1-9 wow fadeIn" data-wow-delay="500ms" style="visibility: hidden; animation-delay: 500ms; animation-name: none;">
                        <img src="/front_assets/img/content/service-detail-03.png" alt="...">
                    </div>
                </div>
                ...
                <div class="row mb-1-9 align-items-center wow fadeIn" data-wow-delay="800ms" style="visibility: hidden; animation-delay: 800ms; animation-name: none;">
                    <div class="col-xl-6 mb-4 mb-xl-0">
                        <img src="/front_assets/img/content/service-detail-03.jpg" alt="...">
                    </div>
