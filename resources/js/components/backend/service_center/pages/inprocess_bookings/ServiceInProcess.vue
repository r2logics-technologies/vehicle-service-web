<template>
    <div class="container-fluid">
      ...
      <Breadcrumb pageTitle="Inprocess Services" :breadcrumbList="breadcrumbList" />
    </div>
        ...
        <div
            class="modal fade"
            :class="isModel ? 'show' : ''"
            :style="isModel ? 'display:table-column-group' : ''"
...
export default {
    ...
    methods: {
                ...
                this.tableData.push({
                    ...
                    data: {
                        ...
                        item3: `<div><span title="${
                            ...
                            element.booking_address.city
                        }</span><span>, ${
                            element.booking_address.state
                        }</span><span>, ${
                            element.booking_address.pincode
                        }</span>`,
                        ...
                        item9: {
                            ...
                            options: {
                                ...
                                icon: "<i class='fa fa-check text-success' title='Complete Service'></i>",
                            },
                        }, 
                        item10:  {
                            type: "action",
                            options: {
                                method: element.booking_url == null ?  this.openModel : this.viewVideo,
                                style: "background:none;border:none",
                                icon: element.booking_url == null ? "<i class='fa fa-plus text-danger'></i>":`<a href="${element.booking_url}" target="_blank" class='fa fa-eye text-success'></a>`,
                            },
                        },
                    },
                    action: false,
        ...
        acceptOrder(item, index) {
            ...
            SwalCustomBtn.fire({
                text: "do you want to Complete this service!",
                icon: "warning",
        ...
        async saveData() {
            ...
            const res = await this.callApi(
                "post",
                "/api/service-center/service_center_bookings/save",
                formData
            );
