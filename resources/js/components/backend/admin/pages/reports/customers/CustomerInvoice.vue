                ...
                <div class="card text-color" v-if="service" style="border: 1px solid #a7a7af;">
                    ...
                    <div class="card-body">
                        <div class="row bservice-top mt-3">
                            <div class="col-md-4">
                                <span class="fw-bolder"><b>Booking Date and Time :</b></span> <br>
    ...
    methods: {
        async showData() {
            const res = await this.callApi(
                "get",
                `/api/admin/reports/customers/service-invoice/${this.$route.params.booking_id}`,
                null
            );
            ...
            if (res.status == 200) {
                ...
                if (data.status == "success") {
                    ...
                    this.breadcrumbList[2].to = `/admin/reports/customer_service_details/${this.service.booking_user.id}`;
                } else {
                    toast = Toast.fire({
                        icon: data.status,
                        title: data.message,
